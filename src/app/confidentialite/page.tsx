export default function Confidentialite() {
  return (
    <main className="max-w-3xl mx-auto px-6 py-24">
      <h1 className="text-3xl font-bold text-[#013a63] mb-8">Politique de confidentialité</h1>
      <div className="prose prose-slate">
        ...
        <h2>Vos droits</h2>
        <p>
          Conformément au RGPD, vous disposez d&apos;un droit d&apos;accès, de rectification et de suppression de vos données. Pour exercer ces droits, contactez-nous à contact@tiwave.app.
        </p>
        <h2>Contact</h2>
        <p>contact@tiwave.app</p>
      </div>
    </main>
  )
}
